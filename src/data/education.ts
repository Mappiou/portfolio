...
export const education: Education[] = [
  {
    ...
    year: 2015,
    kind: "milestone",
    title: { fr: "Baccalauréat", en: "High school diploma", es: "Bachillerato" },
    school: "Lycée",
    location: "France",
    period: { fr: "2015", en: "2015", es: "2015" },
    summary: {
      fr: "Le point de départ du parcours.",
      en: "The starting point of the journey.",
      es: "El punto de partida del recorrido.",
    },
    description: {
      fr: "Obtention du baccalauréat scientifique. La curiosité pour les maths et l'informatique pousse vers une école d'ingénieur.",
      en: "Earned the scientific track of the French baccalaureate. Curiosity for maths and computer science pushes toward an engineering school.",
      es: "Obtención del bachillerato científico. La curiosidad por las matemáticas y la informática me empuja hacia una escuela de ingeniería.",
    },
  },
  {
    id: "utt-start",
